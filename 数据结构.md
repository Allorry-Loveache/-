...
void Level_Order(Node* root) {   //层层遍历
	queue<Node*> q;
	if (root) q.push(root);
...
**超经典案例（同层次左子树永远比右子树小）** ：    <img src="https://raw.githubusercontent.com/Allorry-Loveache/Mybook/main/image/image-20220603190201144.png" alt="image-20220603190201144" style="zoom:50%;" />
